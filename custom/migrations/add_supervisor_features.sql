-- Migration: Add supervisor features and multi-supervisor support
-- Date: 2026-01-13
...
CREATE TABLE IF NOT EXISTS user_supervisors (
    ...
    user_id INT NOT NULL COMMENT 'The user being supervised',
    supervisor_id INT NOT NULL COMMENT 'The supervisor',
